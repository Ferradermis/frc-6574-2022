...
public class Blinkin extends SubsystemBase {
  ...
  public static void rainbowPalette() {
      set(-0.45 );
  }
  public static void wavePartyPalette(){
    set(-.43);
  }

  public static void lavaPalette(){
    set(-.93);
  }
  ...
  public static void forestPalette(){
    set(-0.91);
  }

// could this be useful for LEDs or the getAlliance at the bottom of RobotContainer ???
//changed method to type string and returns led color.
